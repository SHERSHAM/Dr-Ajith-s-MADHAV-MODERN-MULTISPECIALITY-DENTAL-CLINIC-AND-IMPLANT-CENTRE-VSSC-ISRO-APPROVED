  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ background: "var(--gradient-hero)" }}>
      ...
      >
        ...
        <p className="text-white/60 text-sm mb-8">We will send you instructions to reset your password</p>
        ...
        {!submitted ? (
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="space-y-6">
            ...
            <Link href="/login" className="inline-flex items-center gap-2 text-white hover:text-teal-400 font-semibold transition-colors text-sm">
